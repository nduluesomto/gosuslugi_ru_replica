...
Widget securityTile({
  ...
  return GestureDetector(
    onTap: action,
    child: Container(
      padding: const EdgeInsets.symmetric(vertical: AppSizes.paddingVertical + 6, horizontal: AppSizes.sm * 2),
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Text(description,  style: TextStyle(
                      color: AppHelperMethods.isDarkMode(context)? Colors.blueGrey.shade400 :Colors.grey.shade600, fontSize: 13),),
                ),
              ]
          ),
